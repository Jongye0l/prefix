package com.Jongyeol.prefix.Notification;
...
public class madeby extends BukkitRunnable {
    public static void madebyJongyeol() {
        ...
        text.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://github.com/Jongye0l/prefix/blob/main/LICENSE"));
    ...
    @Override
    public void run() {
        Plugin vegan = Bukkit.getPluginManager().getPlugin("VeganSurvival");
        if(vegan == null){
            madebyJongyeol();
        }
    }
